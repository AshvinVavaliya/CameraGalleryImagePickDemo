package image.simform.demo.simplefilechooser.ui;
...
import image.simform.demo.R;
import image.simform.demo.simplefilechooser.Constants;
import image.simform.demo.simplefilechooser.FileInfo;
import image.simform.demo.simplefilechooser.adapters.FileArrayAdapter;
...
public class FileChooserActivity extends ListActivity {
	...
	private void fill(File f) {
		...
		if (!f.getName().equalsIgnoreCase(
			...
			dirs.add(0, new FileInfo("..", Constants.PARENT_FOLDER, f.getParent(), false, true));
		}
